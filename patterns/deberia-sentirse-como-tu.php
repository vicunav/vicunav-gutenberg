...
<!-- wp:group {"tagName":"section","align":"full","backgroundColor":"neutral-300","className":"vicunav-deberia-sentirse","style":{"spacing":{"padding":{"top":"var:preset|spacing|80","right":"var:preset|spacing|site-gutter","bottom":"var:preset|spacing|80","left":"var:preset|spacing|site-gutter"},"blockGap":"0","margin":{"top":"0","bottom":"0"}}},"layout":{"type":"constrained"}} -->
<section class="wp-block-group alignfull vicunav-deberia-sentirse has-neutral-300-background-color has-background" style="margin-top:0;margin-bottom:0;padding-top:var(--wp--preset--spacing--80);padding-right:var(--wp--preset--spacing--site-gutter);padding-bottom:var(--wp--preset--spacing--80);padding-left:var(--wp--preset--spacing--site-gutter)">
	...
	<p class="has-text-align-center has-primary-color has-text-color has-handwritten-font-family has-eyebrow-display-font-size" style="margin-top:0;margin-bottom:var(--wp--preset--spacing--40);font-weight:400;line-height:1"><?php echo esc_html_x( 'Sin presiones, ni tácticas raras', 'Eyebrow de la sección de autenticidad.', 'vicunav' ); ?></p>
	<!-- /wp:paragraph -->

	<!-- wp:heading {"textAlign":"center","level":2,"textColor":"primary","fontFamily":"heading","fontSize":"section-title","style":{"typography":{"fontWeight":"300","lineHeight":"1"},"spacing":{"margin":{"top":"0","bottom":"calc(var(--wp--preset--spacing--50) + var(--wp--preset--spacing--10))"}}}} -->
	<h2 class="wp-block-heading has-text-align-center has-primary-color has-text-color has-heading-font-family has-section-title-font-size" style="margin-top:0;margin-bottom:calc(var(--wp--preset--spacing--50) + var(--wp--preset--spacing--10));font-weight:300;line-height:1"><?php echo esc_html_x( 'Debería Sentirse Como Tú', 'Título de la sección de autenticidad.', 'vicunav' ); ?></h2>
	<!-- /wp:heading -->

	<!-- wp:paragraph {"align":"center","textColor":"text","fontSize":"callout-body","style":{"typography":{"lineHeight":"1.6"},"spacing":{"margin":{"top":"0","bottom":"var:custom|typography|lead-line-height"}}}} -->
	<p class="has-text-align-center has-text-color has-callout-body-font-size" style="margin-top:0;margin-bottom:var(--wp--custom--typography--lead-line-height);line-height:1.6"><?php echo esc_html_x( 'Si ofreces un servicio, lo último que quieres es un sitio web que se sienta agresivo o de ventas. Eso simplemente no es como operas. Tu sitio debería sentirse como lo que eres: claro, honesto, y una extensión natural de cómo ya apoyas a las personas que trabajan contigo.', 'Texto de la sección de autenticidad.', 'vicunav' ); ?></p>
	<!-- /wp:paragraph -->
