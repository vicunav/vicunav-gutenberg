...
<!-- wp:group {"tagName":"section","align":"full","backgroundColor":"neutral-800","className":"vicunav-marcas","style":{"spacing":{"padding":{"top":"var:preset|spacing|70","right":"var:preset|spacing|site-gutter","bottom":"var:preset|spacing|70","left":"var:preset|spacing|site-gutter"},"blockGap":"0","margin":{"top":"0","bottom":"0"}}},"layout":{"type":"constrained"}} -->
<section class="wp-block-group alignfull vicunav-marcas has-neutral-800-background-color has-background" style="margin-top:0;margin-bottom:0;padding-top:var(--wp--preset--spacing--70);padding-right:var(--wp--preset--spacing--site-gutter);padding-bottom:var(--wp--preset--spacing--70);padding-left:var(--wp--preset--spacing--site-gutter)">
	<!-- wp:heading {"textAlign":"center","level":2,"textColor":"neutral-100","fontFamily":"accent-serif","fontSize":"h5","style":{"typography":{"fontWeight":"500","lineHeight":"1"},"spacing":{"margin":{"top":"0","bottom":"var:preset|spacing|60"}}}} -->
	<h2 class="wp-block-heading has-text-align-center has-neutral-100-color has-text-color has-accent-serif-font-family has-h-5-font-size" style="margin-top:0;margin-bottom:var(--wp--preset--spacing--60);font-weight:500;line-height:1"><?php echo esc_html_x( 'Marcas con las que he trabajado', 'Título de la sección de marcas.', 'vicunav' ); ?></h2>
	<!-- /wp:heading -->
