...
<!-- wp:group {"templateLock":"contentOnly","tagName":"section","align":"full","backgroundColor":"neutral-100","textColor":"neutral-800","className":"vicunav-servicios-process is-style-surface-light","style":{"spacing":{"padding":{"top":"var:preset|spacing|90","right":"var:preset|spacing|site-gutter","bottom":"var:preset|spacing|90","left":"var:preset|spacing|site-gutter"},"margin":{"top":"0","bottom":"0"},"blockGap":"0"}},"layout":{"type":"constrained"}} -->
<section class="wp-block-group alignfull vicunav-servicios-process is-style-surface-light has-neutral-800-color has-neutral-100-background-color has-text-color has-background" style="margin-top:0;margin-bottom:0;padding-top:var(--wp--preset--spacing--90);padding-right:var(--wp--preset--spacing--site-gutter);padding-bottom:var(--wp--preset--spacing--90);padding-left:var(--wp--preset--spacing--site-gutter)">
	...
	<p class="has-primary-color has-text-color has-handwritten-font-family has-accent-text-font-size" style="margin-top:0;margin-bottom:var(--wp--preset--spacing--30);font-weight:400;line-height:1"><?php echo esc_html_x( 'Nuestro proceso', 'Eyebrow del proceso de Servicios.', 'vicunav' ); ?></p>
	<!-- /wp:paragraph -->
	<!-- wp:heading {"level":2,"textColor":"neutral-800","fontFamily":"heading","fontSize":"heading-large","align":"wide","style":{"typography":{"fontWeight":"400","lineHeight":"1.08"},"spacing":{"margin":{"top":"0","bottom":"var:preset|spacing|70"}}}} -->
	<h2 class="wp-block-heading alignwide has-neutral-800-color has-text-color has-heading-font-family has-heading-large-font-size" style="margin-top:0;margin-bottom:var(--wp--preset--spacing--70);font-weight:400;line-height:1.08"><?php echo esc_html_x( 'Un proceso claro y acompañado, del inicio al lanzamiento', 'Título del proceso de Servicios.', 'vicunav' ); ?></h2>
	<!-- /wp:heading -->
				...
				<?php foreach ( $steps as $step ) : ?>
					...
					<div class="wp-block-group vicunav-servicios-process__step" style="padding-top:var(--wp--preset--spacing--30);padding-bottom:var(--wp--preset--spacing--30)">
						...
						<div class="wp-block-group vicunav-servicios-process__copy">
							<!-- wp:heading {"level":3,"textColor":"neutral-800","fontFamily":"heading","fontSize":"heading-small","style":{"typography":{"fontWeight":"500","lineHeight":"1.15"},"spacing":{"margin":{"top":"0","bottom":"var:preset|spacing|20"}}}} -->
							<h3 class="wp-block-heading has-neutral-800-color has-text-color has-heading-font-family has-heading-small-font-size" style="margin-top:0;margin-bottom:var(--wp--preset--spacing--20);font-weight:500;line-height:1.15"><?php echo esc_html( $step[2] ); ?></h3>
							<!-- /wp:heading -->
							<!-- wp:paragraph {"textColor":"accent","style":{"typography":{"fontWeight":"400","lineHeight":"1.5"},"spacing":{"margin":{"top":"0","bottom":"0"}}}} -->
							<p class="has-accent-color has-text-color" style="margin-top:0;margin-bottom:0;font-weight:400;line-height:1.5"><?php echo esc_html( $step[3] ); ?></p>
							<!-- /wp:paragraph -->
						</div>
						<!-- /wp:group -->
					</div>
