...
<div class="wp-block-cover alignfull is-light vicunav-hero" style="margin-top:0;margin-bottom:0;padding-top:var(--wp--preset--spacing--40);padding-right:var(--wp--preset--spacing--65);padding-bottom:var(--wp--preset--spacing--80);padding-left:var(--wp--preset--spacing--65)"><img class="wp-block-cover__image-background" alt="" src="<?php echo esc_url( get_theme_file_uri( 'assets/images/hero-vicunav.webp' ) ); ?>" data-object-fit="cover"/><span aria-hidden="true" class="wp-block-cover__background has-background-dim-100 has-background-dim wp-block-cover__gradient-background has-background-gradient has-hero-readability-gradient-background"></span><div class="wp-block-cover__inner-container">
	...
	<div class="wp-block-group alignwide vicunav-hero__content">
		<!-- wp:paragraph {"align":"center","textColor":"neutral-800","fontFamily":"handwritten","fontSize":"heading-small","style":{"typography":{"fontWeight":"400","lineHeight":"1"},"spacing":{"margin":{"top":"0","bottom":"var:preset|spacing|50"}}}} -->
		<p class="has-text-align-center has-neutral-800-color has-text-color has-handwritten-font-family has-heading-small-font-size" style="margin-top:0;margin-bottom:var(--wp--preset--spacing--50);font-weight:400;line-height:1"><?php echo esc_html_x( 'Para profesionales independientes y negocios', 'Eyebrow del Hero.', 'vicunav' ); ?></p>
		<!-- /wp:paragraph -->

		<!-- wp:heading {"textAlign":"center","level":1,"textColor":"neutral-900","fontFamily":"heading","fontSize":"heading-large","className":"vicunav-hero__title","style":{"spacing":{"margin":{"top":"0","bottom":"var:preset|spacing|60"}}}} -->
		<h1 class="wp-block-heading has-text-align-center vicunav-hero__title has-neutral-900-color has-text-color has-heading-font-family has-heading-large-font-size" style="margin-top:0;margin-bottom:var(--wp--preset--spacing--60)"><?php echo wp_kses_post( _x( 'Tu <em>sitio web</em> es el <u>primer paso</u> que tus clientes dan <em>hacia ti</em>', 'Título principal del Hero.', 'vicunav' ) ); ?></h1>
		<!-- /wp:heading -->
