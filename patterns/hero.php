...
<!-- wp:cover {"url":"<?php echo esc_url( get_theme_file_uri( 'assets/images/hero-vicunav.webp' ) ); ?>","alt":"","dimRatio":0,"overlayColor":"neutral-100","isUserOverlayColor":true,"isDark":false,"align":"full","className":"vicunav-hero","style":{"dimensions":{"minHeight":"clamp(35.663rem, 35.157rem + 2.16vw, 37.063rem)"},"spacing":{"padding":{"top":"clamp(var(--wp--preset--spacing--40), 2.352rem - 1.502vw, var(--wp--preset--spacing--60))","right":"var:preset|spacing|70","bottom":"clamp(var(--wp--preset--spacing--60), 1.296rem + 3.005vw, var(--wp--preset--spacing--80))","left":"var:preset|spacing|70"},"margin":{"top":"0","bottom":"0"}}},"layout":{"type":"constrained"}} -->
<div class="wp-block-cover alignfull is-light vicunav-hero" style="min-height:clamp(35.663rem, 35.157rem + 2.16vw, 37.063rem);margin-top:0;margin-bottom:0;padding-top:clamp(var(--wp--preset--spacing--40), 2.352rem - 1.502vw, var(--wp--preset--spacing--60));padding-right:var(--wp--preset--spacing--70);padding-bottom:clamp(var(--wp--preset--spacing--60), 1.296rem + 3.005vw, var(--wp--preset--spacing--80));padding-left:var(--wp--preset--spacing--70)"><span aria-hidden="true" class="wp-block-cover__background has-neutral-100-background-color has-background-dim-0 has-background-dim"></span><img class="wp-block-cover__image-background" alt="" src="<?php echo esc_url( get_theme_file_uri( 'assets/images/hero-vicunav.webp' ) ); ?>" data-object-fit="cover"/><div class="wp-block-cover__inner-container">
