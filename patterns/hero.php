...
<!-- wp:cover {"url":"<?php echo esc_url( get_theme_file_uri( 'assets/images/hero-vicunav.webp' ) ); ?>","alt":"","dimRatio":100,"gradient":"hero-readability","isDark":false,"align":"full","className":"vicunav-hero","style":{"spacing":{"padding":{"top":"var:preset|spacing|40","right":"var:preset|spacing|hero-gutter","bottom":"var:preset|spacing|80","left":"var:preset|spacing|hero-gutter"},"margin":{"top":"0","bottom":"0"}}},"layout":{"type":"constrained"}} -->
<div class="wp-block-cover alignfull is-light vicunav-hero" style="margin-top:0;margin-bottom:0;padding-top:var(--wp--preset--spacing--40);padding-right:var(--wp--preset--spacing--hero-gutter);padding-bottom:var(--wp--preset--spacing--80);padding-left:var(--wp--preset--spacing--hero-gutter)"><img class="wp-block-cover__image-background" alt="" src="<?php echo esc_url( get_theme_file_uri( 'assets/images/hero-vicunav.webp' ) ); ?>" data-object-fit="cover"/><span aria-hidden="true" class="wp-block-cover__background has-background-dim-100 has-background-dim wp-block-cover__gradient-background has-background-gradient has-hero-readability-gradient-background"></span><div class="wp-block-cover__inner-container">
