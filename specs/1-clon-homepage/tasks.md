...
|---|---:|---|---|---|---|
| T-01 | #3 | Pattern hero registrado, asset local aprobado y template incremental iniciado | AC-02; inicio de AC-10 | #2, #19 | Lint, render de `/`, copy y captura responsive |
